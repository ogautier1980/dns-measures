...
\textbf{TXT records} carry free-text information and are used for SPF (Sender Policy Framework), DKIM (DomainKeys Identified Mail), DMARC configuration, and domain validation tokens for certificate authorities.
...
Geographic vantage & Single point (Netherlands) & \textasciitilde{}12,900 probes, 178 countries & Systematic multi-continent coverage \\
