% Chapitre 1 - Généré automatiquement depuis chapitre1_introduction.md
...
RIPE Atlas, notre infrastructure de mesures distribuées, présente un biais géographique documenté ~\cite{TODO}. Cette question évalue si ce biais limite la validité de nos observations. Si les sondes asiatiques et africaines (minoritaires) apportent des réponses DNS radicalement différentes, alors notre échantillon est biaisé. Si au contraire elles confirment les tendances observées en Europe/Amérique du Nord, le biais est acceptable.
...
\begin{itemize}
\item 10,000 domaines x 100 sondes x 1 mesure/jour x 90 jours = \textbf{90 millions de résultats}
...
\begin{itemize}
\item Interférence entre mesures concurrentes sur RIPE Atlas ~\cite{TODO}
...
\begin{itemize}
\item 91\% sondes RIPE Atlas en Europe + Amérique du Nord ~\cite{TODO}
...
Nous utilisons la \textbf{liste Tranco} (Le Pochat et al., 2019) plutôt que les listes commerciales pour trois raisons principales :
...
\textbf{Résistance à la manipulation} : Tranco requiert 4x plus d'effort pour manipulation que les listes individuelles. Alexa peut être manipulé avec une seule requête HTTP, rendant la liste peu fiable pour la recherche académique.
...
\textbf{Distribution géographique} : 12,900 sondes actives dans 178 pays ~\cite{TODO}, offrant une couverture mondiale impossible à obtenir avec une infrastructure propriétaire.
...
\begin{itemize}
\item Biais géographique (91\% Europe+NA) -> Mitigation par pondération
\item Interférence mesures concurrentes -> Mitigation par sélection hardware récent
\item Crédits limités -> Optimisation stratégie de mesure
\end{itemize}
...
\textbf{Étape 2 - Measurement Scheduling} : Configuration mesures RIPE Atlas (100 sondes, 1x/jour, filtres géographiques et techniques).
...
\textbf{Technique} :
\begin{itemize}
\item [OK] Collecte >=85\% résultats valides (taux exclusion <15\%)
\item [OK] Couverture >=95\% domaines Tranco Top 10K
\item [OK] Distribution géographique >=4 continents représentés
\end{itemize}
