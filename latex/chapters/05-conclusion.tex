...
\textbf{Empirical validation of literature hypotheses.}
...
\midrule
Anycast inflation is CDN-context-dependent & Koch et al.\textasciitilde{}\cite{Koch2021} & [Confirmed / Qualified] \\
Public DNS imposes $\geq$14\% throughput penalty vs. ISP & Hours et al.\textasciitilde{}\cite{Hours2016} & [Confirmed / Magnitude differs] \\
ECS mitigates remote-DNS geographic mismatch & Wang et al.\textasciitilde{}\cite{Wang2018}; RFC\textasciitilde{}7871\textasciitilde{}\cite{RFC7871} & [Partially confirmed / Not confirmed] \\
RIPE Atlas geographic bias persists post-2017 & Bajpai et al.\textasciitilde{}\cite{Bajpai2017} & [Confirmed] \\
DNS infrastructure is oligopolistically concentrated & Xu et al.\textasciitilde{}\cite{Xu2023} & [Confirmed for Top-10K] \\
\bottomrule
\end{tabular}
\end{table}
