...
acceptable method of mapping host addresses to host names; use the INADDR.ARPA domain instead.
...
name corresponding to the mailbox. Thus the mailbox HOSTMASTER@SRINIC.ARPA is mapped into the domain name HOSTMASTER.SRI-NIC.ARPA. If the
...
S. Dyer, F. Hsu, "Hesiod", Project Athena
...
M. Stahl, "Establishing a Domain - Guidelines for
