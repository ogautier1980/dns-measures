...
Kisteleki~\cite{Kisteleki2016} traces RIPE Atlas measurement ethics back to the Menlo Report~\cite{Bailey2012}. The argument: a probe host takes responsibility for what their hardware sends; a researcher scheduling a campaign on borrowed hardware inherits that same responsibility. This campaign stays within those bounds. Every queried domain is publicly accessible. Daily query rate is far below the minimum \ac{TTL} floor in the corpus. No politically sensitive names were included.
